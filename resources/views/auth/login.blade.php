                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="pt-5">
                            <div class="d-flex justify-content-center">
                                <div class="px-2">
                                    <a href="{{url('auth/google')}}" type="submit" class="btn btn-danger">
                                            {{ __('Login with Google') }}
                                    </a>
                                </div>
                                <div class="px-2">
                                    <a href="{{url('login/facebook')}}" type="submit" class="btn btn-primary">
                                            {{ __('Login with Facebook') }}
                                    </a>
                                </div>
                                <div class="px-2">
                                    <a href="{{url('login/twitter')}}" type="submit" class="btn btn-info">
                                            {{ __('Login with Twitter') }}
                                    </a>
                                </div>
                                <div class="px-2">
                                    <a href="{{url('login/github')}}" type="submit" class="btn btn-warning">
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" style="margin-top: -4px;" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"  viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                            <g>
                                                <g>
